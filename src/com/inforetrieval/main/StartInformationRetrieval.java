...
//			
//			String query = null;
			String filePath = "e:\\test_data";
			String indexPath ="e:\\sada";
			String rankingModel = "VS";
			...
			if (!Files.exists(Paths.get(filePath))) {
				...
				System.out.println(Constants.HELP_MESSAGE);
				System.exit(0); //Prompt the user to re-run if wrong path was entered and exit.
			} 
	...
	/** Start execution of indexing files and searching given query based on the ranking model provided. 
	 * @param filePath
	 * @param indexPath
	 * @param rankingModel
	 * @param query
	 * @throws Exception
	 */
	private static void executeTask(String filePath, String indexPath, String rankingModel, String query) throws Exception {
